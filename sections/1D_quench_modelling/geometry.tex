...
% In the superconducting magnet design community, an assumption is often proposed to simulate the materials behaviour outside of the superconducting cable as a single domain characterized by the properties of G10 which is another material widely used in cryogenics. Such an assumption is made in this thesis. 

% The characteristics of all material properties taken into consideration in the analysis are described in Appendix \ref{appendix_material_properties_description}. 

% The next goal of this analysis is to perform the simulation on the skew quadrupole which is described in chapter \ref{section:skew_quadrupole_quench_detection_analysis}. Therefore, some geometric parameters applied to this analysis are directly taken from the input data about this particular corrector magnet. They are presented in Table
