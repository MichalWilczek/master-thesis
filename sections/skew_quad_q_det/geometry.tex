...
The winding scheme is shown in Fig.~\ref{fig:winding_scheme_cross_section}. Winding~1 is placed at the bottom left of the 2D cross-section. The last winding number 754 is placed further in the \textit{x}-direction. The~\nth{2} half of the coil is a~mirror image of the presented winding scheme.~\cite{marco_prioli_mails}
